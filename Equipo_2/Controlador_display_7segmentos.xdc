...
## Clock signal
set_property PACKAGE_PIN W5 [get_ports i_Reloj]							
	set_property IOSTANDARD LVCMOS33 [get_ports i_Reloj]
	create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports i_Reloj]
...
set_property PACKAGE_PIN U2 [get_ports {o_Anodo_4_Bits[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_Anodo_4_Bits[0]}]
set_property PACKAGE_PIN U4 [get_ports {o_Anodo_4_Bits[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_Anodo_4_Bits[1]}]
set_property PACKAGE_PIN V4 [get_ports {o_Anodo_4_Bits[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_Anodo_4_Bits[2]}]
set_property PACKAGE_PIN W4 [get_ports {o_Anodo_4_Bits[3]}]					
